...
import com.aristotele.noteapp.data.repository.MainRepository
import com.aristotele.noteapp.utils.DataStatus
...
class MainViewModel @Inject constructor(private val repository: MainRepository) : ViewModel() {
    ...
    /**
     * نکتههههههههههههههههههههههههههههههههههههههههههههههههه
     * امدیم از کلاس کنترلی خودمون استفاده کردیم
     * DataStatus
     * راحت چک میکنه وضعیت این لیست چی هست الان خالی یا پِره
     * و یک بولین برمیگرئونه فکر کنم
     */
